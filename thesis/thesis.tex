...
\begin{appendices}
    ...
    \newpage
    \subsection{Derivation of $\Gamma,\phi \vee (\psi \vee \gamma) \vdash (\phi \vee \psi) \vee \gamma$}
    ...
    \subsection{Derivation of $\Gamma,\phi \wedge (\psi \vee \gamma) \vdash (\phi \wedge \psi) \vee (\phi \wedge \gamma)$}
    \begin{mathpar}
        \mprset{sep=1em}
        \inferrule*[right=\scriptsize $\vee$-E]
            {\inferrule*[right=\scriptsize $\wedge$-E$_2$]
    ...
    \subsection{Derivation of $\Gamma,(\phi \wedge \psi) \vee (\phi \wedge \gamma) \vdash \phi \wedge (\psi \vee \gamma)$}
    ...
    \subsection{Derivation of $\Gamma,\phi \vee (\psi \wedge \gamma) \vdash (\phi \vee \psi) \wedge (\phi \vee \gamma)$}
    ...
    \newpage
    \subsection{Derivation of $\Gamma,(\phi \vee \psi) \wedge (\phi \vee \gamma),\phi \vdash \phi \vee (\psi \wedge \gamma)$}
